...
from bookwyrm.forms import SuggestionForm, BookSuggestionForm
...
class ModifyBookSuggestion(UpdateView):
    """Separate page for modifying each genre suggestion in admin page."""
    template_name = "settings/genres/book_suggestion_mod.html"
    model = SuggestedBookGenre
