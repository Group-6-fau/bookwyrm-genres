...
(function ($, undefined) {
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _getHandle: function (event) {
            var handle =
                !this.options.handle || !$(this.options.handle, this.element).length ? true : false;
    ...
    $.ui.plugin.add("draggable", "snap", {
        start: function (event, ui) {
            ...
            $(o.snap.constructor != String ? o.snap.items || ":data(draggable)" : o.snap).each(
                function () {
                    var $t = $(this);
                    var $o = $t.offset();
                    if (this != i.element[0])
...
(function ($, undefined) {
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        _intersectsWith: function (item) {
            ...
            var isOverElement =
                y1 + dyClick > t && y1 + dyClick < b && x1 + dxClick > l && x1 + dxClick < r;
        ...
        _create: function () {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function (event, ui) {
                    ...
                    var item =
                        ui.item.data("ui-autocomplete-item") || ui.item.data("item.autocomplete");
        ...
        $.widget("ui.tabs", $.ui.tabs, {
            ...
            add: function (url, label, index) {
                ...
                var doInsertAfter,
                    ...
                    options = this.options,
                    li = $(
                        options.tabTemplate.replace(/#\{href\}/g, url).replace(/#\{label\}/g, label)
                    ),
